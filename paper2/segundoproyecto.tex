...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{fig/SenoSola.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{fig/TriangularYcuadrada.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{fig/SenoContraTriangular.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{fig/PWM.png} 
  \caption{PWM}
  \label{fig:PWM}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{fig/SenoConPWm.png} 
